...
function renderDefaultScope() {
  if (!_get(_globalThis, 'document')) {
    return;
  }

  var container = _run(_globalThis, 'document.createElement', 'div'); // compatible with react 18


  if (ReactDOM.createRoot) ReactDOM.createRoot(container).render( /*#__PURE__*/React__default.createElement(AliveScope, {
    _nk: "".concat(_filehash$8, "41")
  }));else ReactDOM.render( /*#__PURE__*/React__default.createElement(AliveScope, {
    _nk: "".concat(_filehash$8, "42")
  }), container);
}
